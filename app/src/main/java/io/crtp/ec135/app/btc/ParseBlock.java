...
public class ParseBlock {
    ...
    private JSONObject jsonBlock = null;
    private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
    private String dateStr = "not set";
    private int number_Of_Trxs = -1;

    public ParseBlock( MariaDB mdb, BitcoinRPCs rpc ) {
        db = mdb;
        bitcoinRPCs = rpc;
    }
    ...
    public void setBlock(int num){
        ...
        JSONArray trxs = (JSONArray) ( (JSONObject)jsonBlock.get("result") ).get("tx");
        number_Of_Trxs = trxs.size();
    ...
    public void addressScan() {
        ...
        r2.append( blockNumString( getBlockNum() ) );
